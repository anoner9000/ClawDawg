...
- Generated: 2026-02-24T16:47:29Z
...
## Top matches (file-level)
 ...
 -       4 ops/scripts/runtime/write_proof_receipt.py
 ...
 -       2 ops/scripts/runtime/write_proof_receipt.py.bak.20260224T164729Z
...
ops/scripts/runtime/write_proof_receipt.py.bak.20260224T164729Z:148:        "schema": "openclaw.proof_receipt.v1",
ops/scripts/runtime/write_proof_receipt.py.bak.20260224T164729Z:165:    print(f"proof_receipt={receipt_path}")
ops/scripts/runtime/write_proof_receipt.py:9:from ops.governance.receipts import build_legacy_proof_receipt_v1
ops/scripts/runtime/write_proof_receipt.py:12:    ap = argparse.ArgumentParser(description="Write a legacy proof receipt (thin wrapper).")
ops/scripts/runtime/write_proof_receipt.py:24:    receipt = build_legacy_proof_receipt_v1(
ops/scripts/runtime/write_proof_receipt.py:34:    print(f"proof_receipt={out}")
